    ...
    <>
      ...
      {menuOpen && (
        <div className="sideMenu sm:hidden bg-[#be0b32] h-screen w-full py-[17vw] text-[10vw] px-5 text-white font-mono shadow-inner ">
          {menuOpen && (
          <div className="sideMenu sm:hidden bg-[#be0b32] h-screen w-full py-[17vw] text-[10vw] px-5 text-white font-mono shadow-inner ">
            <h4 className="" onClick={() => setMenuOpen(false)}>Home</h4>
            <h4 className="" onClick={() => setMenuOpen(false)}>About Us</h4>
            <h4 className="" onClick={() => setMenuOpen(false)}>Services</h4>
            <h4 className="" onClick={() => setMenuOpen(false)}>Contact Us</h4>
